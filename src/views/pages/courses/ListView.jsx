...
const options = [
    ...
    { text: 'Enroll Students', icon: <SourceIcon sx={{ marginRight: 1, verticalAlign: 'middle' }} fontSize="small" /> }
];
...
const CourseCard = ({ course, handleClick, setLoading, setCourses, courses }) => {
    ...
    return (
        <Card
            sx={{ display: 'flex', width: '100%', padding: 2, marginBottom: 4, marginTop: 4, flexDirection: { xs: 'column', md: 'row' } }}
        >
